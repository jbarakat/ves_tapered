...
def readLT(homedir, redvol, confin, capnum) :	
	...
	# load data files
	outdir	= homedir + '/../../allCa/output/v' + redvol + '/conf' + confin + '/*Ca' + capnum + '.dat'
	substring = homedir + '/../../allCa/output/v' + redvol + '/conf' + confin + '/sln_v' + redvol + '_conf' + confin + '_Ca'
...
# get profiles at fixed v, conf, Ca (high-Ca limit)
def readLTHighCa(homedir, redvol, confin) :	
	import numpy as np
	from numpy import nan
	import glob
	from math import pi
	...
	# load data files
	outdir	= homedir + '/../output/v' + redvol + '/conf' + confin + '/*CaInf.dat'
	files	= sorted(glob.glob(outdir))
	nfiles = len(files)
